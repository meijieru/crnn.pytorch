...
if __name__ == '__main__':
    model_path = './expr/netCRNN_29.pth'
    # model_path = './expr/model.pkl'
    img_path = '/data/datasets/segment-free/test/1_song5_0_3.jpg'
    alphabet = Alphabet.CHINESECHAR_LETTERS_DIGITS_EXTENDED
    # 初始化网络
    net = crnn.CRNN(32, 1, len(alphabet), 256)
    model = Pytorch_model(model_path, alphabet = alphabet,net=net, img_shape=[200,32], img_channel=1)
    # 执行预测
