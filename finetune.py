...
alphabet = ""
with open('/home/rice/PycharmProjects/crnn.pytorch-master/mydict.txt', 'r') as file:
...
parser.add_argument('--trainroot', default='/run/media/rice/DATA/test_text/lmdb/', help='path to dataset')
parser.add_argument('--valroot', default='/run/media/rice/DATA/test_text/lmdb/', help='path to dataset')
...
parser.add_argument('--crnn', default='/home/rice/PycharmProjects/crnn.pytorch-master/model/1.pth', help="path to crnn (to continue training)")
